...
Wie würden Sie diese E-Mail kategorisieren?`,
      ...
      shareDialog: {
        ...
        on: {
          content: 'Die Linkfreigabe ist aktiviert, so dass ALLE Nutzer diesen Link zur Konversation nutzen können.',
        },
      },
      error: {
    ...
    error: {
      ...
      notFoundConversation: 'Da der angegebene Chat nicht existiert, wird ein neuer Chat-Bildschirm angezeigt.',
