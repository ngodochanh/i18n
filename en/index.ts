const translation = {
  translation: {
    ...
    agent: {
      label: 'Agent',
      help: {
        overview: 'By using the Agent functionality, your chatbot can automatically handle more complex tasks.',
      },
      ...
      tools: {
        ...
        sql_db_query: {
          name: 'Database Query',
          description: 'Execute a detailed and correct SQL query to retrieve results from the database.',
        },
        sql_db_schema: {
          name: 'Database Schema',
          description: 'Retrieve the schema and sample rows for a list of tables.',
        },
        sql_db_list_tables: {
    ...
    bot: {
      label: {
        ...
        dndFileUpload: 'You can upload files by drag and drop.\nSupported files: {{fileExtensions}}',
      ...
      help: {
        ...
        quickStarter: {
          overview: 'When starting a conversation, provide examples. Examples illustrate how to use the bot.',
        },
      },
      alert: {
        sync: {
...
How would you categorize this email?`,
      ...
      apiSettings: {
        ...
        help: {
          ...
          rateLimit: 'Enter the rate, in requests per second, that clients can call your API.',
          burstLimit: 'Enter the number of concurrent requests that a client can make to your API.',
          quota: 'Turn on quotas to limit the number of requests a user can make to your API in a given time period.',
          requestLimit:
      ...
      shareDialog: {
        title: 'Share',
        off: {
          content: 'Link sharing is off, so only you can access this bot through its URL.',
        },
        on: {
          content: 'Link sharing is on, so ALL users can use this link to conversation.',
        },
      },
      error: {
    ...
    admin: {
      ...
      botManagement: {
        label: {
          ...
          usagePlanOn: 'ON',
          usagePlanOff: 'OFF',
          rateLimit: '<Bold>{{limit}}</Bold> requests per second, that clients can call the API.',
          burstLimit: 'The client can make <Bold>{{limit}}</Bold> concurrent requests to the API.',
          requestsLimit: 'You can make <Bold>{{limit}}</Bold> requests <Bold>{{period}}</Bold>.',
        },
        alert: {
          noApiKeys: {
            title: 'No API Keys',
    ...
    error: {
      ...
      notFoundConversation: 'Since the specified chat does not exist, a new chat screen is displayed.',
      ...
      predict: {
        ...
        invalidResponse: 'Unexpected response received. The response format does not match the expected format.',
      },
      ...
      totalFileSizeToSendExceeded: 'The total file size must be no more than {{maxSize}}.',
      attachment: {
        fileSizeExceeded: 'Each document size must be no more than {{maxSize}}.',
